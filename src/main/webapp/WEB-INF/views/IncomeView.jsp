	...
	<div class="content">
		...
		<div class="container-fluid pt-4 px-4">
			<div class="bg-secondary rounded p-4">
				...
				<h3 class="text-white mb-4">Income Details</h3>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="row mb-3">
							<div class="col-md-4 text-muted">Income ID</div>
							<div class="col-md-8">${income.incomeId}</div>
						</div>
					...
					<div class="col-md-6">
						...
						<div class="row mb-3">
							...
							<div class="col-md-8">${income.amount}</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-md-8">${income.userId}</div>
						</div>
				...
				<div class="d-flex justify-content-end mt-4">
					<a href="incomeList" class="btn btn-dark me-2">Back</a>
